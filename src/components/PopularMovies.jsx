    ...
    <div className="flex flex-wrap justify-center items-start mx-auto w-5/6 px-4 mb-12 z-10">
      ...
      <div className="grid grid-cols-2 gap-4 w-full">
        {movies.map((movie, index) => {
          ...
          return (
            <div key={movie.id} className={`${sizeClass} flex flex-row justify-between p-4 bg-gray-200 rounded-lg shadow`}>
              {index < 2 ? (
                <>
                  <img src={`assets/${index + 1}.png`} alt="Show All" className='h-8 w-8 bottom-2 right-2' />
